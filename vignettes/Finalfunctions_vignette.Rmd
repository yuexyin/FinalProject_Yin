...
<font size="3">This function helps with the first step of data analysis, which is filtering data. There are some criteria regarding the cell quality (This function requires dplyr package). The has to be:        
